...
$games = require( __DIR__.'/_games.php' ) ;

foreach ($games as $game): ?>

<div class="game">
<div class="title"><strong><?= $game['name'] ?></strong></div>
...
<div class="c" ><span class="label" >GAMEPLAY</span>: <span class="gameplay" ><?= $game['gameplay'] ?> </span> </div>
